 ...
 * create POST /applications/{application.id}/commands
 * get GET /applications/{application.id}/commands/{command.id}
 * edit PATCH /applications/{application.id}/commands/{command.id}
 * delete DELETE /applications/{application.id}/commands/{command.id}
